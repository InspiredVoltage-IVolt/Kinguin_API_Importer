...
/// <summary>
/// Execute PROC_PRODUCT_CREATE_RELATIONSHIPS
/// </summary>
/// <returns>I_QueryResult</returns>


namespace IVolt.Kinguin.API.LocalDB.PROC.PRODUCT.CREATE.RELATIONSHIPS
{
    public static class Execute
    {
        public static I_QueryResult Proc(string Conn = "")
        {
            using (var DataAccess = CurrentCore<I_DataAccess>.GetCurrent())
            {
                ...
                #region Param Values
                #endregion
                var _Result = DataAccess.RunCommand("[dbo].PROC_PRODUCT_CREATE_RELATIONSHIPS", _Params, true, System.Data.CommandType.StoredProcedure);
                return _Result;
            }
        }
    }

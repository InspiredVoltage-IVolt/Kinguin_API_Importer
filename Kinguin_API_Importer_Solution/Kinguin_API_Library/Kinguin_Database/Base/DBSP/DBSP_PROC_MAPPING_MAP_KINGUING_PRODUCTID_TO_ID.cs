...
using ACT.Core.Extensions.CodeGenerator;
    /// <summary>
/// Execute PROC_MAPPING_MAP_KINGUING_PRODUCTID_TO_ID
/// </summary>
/// <returns>I_QueryResult</returns>


namespace IVolt.Kinguin.API.LocalDB.PROC.MAPPING.MAP.KINGUING.PRODUCTID.TO.ID
{
...
public static I_QueryResult Proc(string Conn = "")
{
	...
	#region Param Values
	#endregion
	var _Result = DataAccess.RunCommand("[dbo].PROC_MAPPING_MAP_KINGUING_PRODUCTID_TO_ID", _Params, true, System.Data.CommandType.StoredProcedure);
	return _Result;
}}}

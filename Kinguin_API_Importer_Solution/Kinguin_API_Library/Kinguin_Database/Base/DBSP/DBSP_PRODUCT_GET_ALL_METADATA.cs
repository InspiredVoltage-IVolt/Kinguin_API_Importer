...
namespace IVolt.Kinguin.API.LocalDB.PRODUCT.GET.ALL.METADATA
{
...
public static I_QueryResult Proc(string Conn = "")
{
	...
	#region Param Values
	#endregion
	var _Result = DataAccess.RunCommand("[dbo].PRODUCT_GET_ALL_METADATA", _Params, true, System.Data.CommandType.StoredProcedure);
	return _Result;
}}}

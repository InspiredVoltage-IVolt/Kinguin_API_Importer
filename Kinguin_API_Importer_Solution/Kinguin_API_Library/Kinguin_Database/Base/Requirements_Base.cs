...
{
	public class Requirements_CoreClass : ACT.Plugins.ACT_Core, ACT.Core.Interfaces.DataAccess.I_DataObject 
	{
	...
	private string _LocalConnectionString = "";
		...
		private string __Requirement;
		private string __Requirement_Description = "";
		private string __System_R;
		private string __System_R_Description = "";
	...
	public virtual string PrimaryKey { get { return "ID"; } }		public virtual int? ID
		...
		{
			get { return __Requirement; }
			set { __Requirement = value; }
		}

		public virtual string Requirement_Description
		{
			get { return __Requirement_Description; }
			set { __Requirement_Description = value; }
		}

		public virtual string System_R
		{
			get { return __System_R; }
			set { __System_R = value; }
		}

		public virtual string System_R_Description
		{
			get { return __System_R_Description; }
			set { __System_R_Description = value; }
		}
...
public static ACT.Core.Interfaces.DataAccess.I_DataAccess GetDataAccess()
{
	...
	#region Public Parent Tables
		...
		public Requirements_CoreClass(string localConnectionString = ""){ LocalConnectionString = localConnectionString; }


		public Requirements_CoreClass(int? ID, string localConnectionString = "") 
		{
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		...
		var SQL = "Select * From Requirements Where [ID] = @IDParam";
	...
	#region Public Static Search Methods
		...
		public static List<Requirements> GetRequirements(I_DbWhereStatement Where, string sql = "", string LocalConnectionString = "")
		{
		List<Requirements> _TmpReturn = new List<Requirements>();
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		if (LocalConnectionString == "") {
		...
		var QR = DataAccess.RunCommand("Select [ID] From Requirements Where " + _Where, _Params, true, System.Data.CommandType.Text);
		if (QR.Tables[0].Rows.Count > 0)
		{
		    foreach (System.Data.DataRow r in QR.Tables[0].Rows)
		    {
		        _TmpReturn.Add(new Requirements((int?)r["ID"]));
		    }
		}
return _TmpReturn;
		}}

public static List<Requirements> Search(string FieldName, string SearchText, bool UseContains = false, string LocalConnectionString = "")
{
List<Requirements> _TmpReturn = new List<Requirements>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select Requirements.ID From Requirements Where [" + FieldName + "] like '%' + @SearchParam + '%'";
} 
else { 
SQL = SQL + "Select Requirements.ID From Requirements Where [" + FieldName + "] = @SearchParam";
}
...
{
_TmpReturn.Add(new Requirements((int)Result.Tables[0].Rows[x]["ID"]));
}
}
}}
return _TmpReturn;
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From Requirements Where [" + FieldName + "] like '%' + @SearchParam + '%') as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
} 
else { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From Requirements Where [" + FieldName + "] = @SearchParam) as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
}
...
public static List<Requirements> Search(Dictionary<string,string> FieldValues, string LocalConnectionString = "")
{
List<Requirements> _TmpReturn = new List<Requirements>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
SQL = SQL + "Select Requirements.ID From Requirements where ";
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From Requirements Where [" + FieldName + "] like '%' + @SearchParam + '%'";} 
else { 
SQL = SQL + "Select * From Requirements Where [" + FieldName + "] = @SearchParam";}
...
_Params.Add(new System.Data.SqlClient.SqlParameter("Requirement_Param", this.Requirement));
SQLInsertFields += "[Requirement], ";
SQLValues += "@Requirement_Param, ";
}
if (this.System_R != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("System_R_Param", this.System_R));
SQLInsertFields += "[System], ";
SQLValues += "@System_R_Param, ";
}
...
string _SQL = "Insert Into [Requirements] ( " + SQLInsertFields + ") Values (" + SQLValues + ")";
...
if (this.Requirement != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Requirement_Param", this.Requirement));
SQLInsertFields += "[Requirement] = @Requirement_Param, ";
}
if (this.System_R != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("System_R_Param", this.System_R));
SQLInsertFields += "[System] = @System_R_Param, ";
}
if (this.DateAdded != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("DateAdded_Param", this.DateAdded));
...
string _SQL = "Update [Requirements] set " + SQLInsertFields + " Where " + SQLValues;
var _TmpReturn = DataAccess.RunCommand(_SQL, _Params.ToList<System.Data.IDataParameter>(), false, System.Data.CommandType.Text);
...
SQLValues = SQLValues.TrimEnd("AND ".ToCharArray());
string _SQL = "Delete From [Requirements] Where " + SQLValues;

...
{
	public class KinguinProduct_To_Images_CoreClass : ACT.Plugins.ACT_Core, ACT.Core.Interfaces.DataAccess.I_DataObject 
	{
	...
	private string _LocalConnectionString = "";
		...
		private int? __Image_ID;
		private string __Image_ID_Description = "";
		private int? __Type_ID;
		private string __Type_ID_Description = "";
	...
	public virtual string PrimaryKey { get { return "ID"; } }		public virtual int? ID
		...
		public virtual int? Image_ID
		{
			get { return __Image_ID; }
			set { __Image_ID = value; }
		}

		public virtual string Image_ID_Description
		{
			get { return __Image_ID_Description; }
			set { __Image_ID_Description = value; }
		}

		public virtual int? Type_ID
		{
			get { return __Type_ID; }
			set { __Type_ID = value; }
		}

		public virtual string Type_ID_Description
		{
			get { return __Type_ID_Description; }
			set { __Type_ID_Description = value; }
		}
...
public static ACT.Core.Interfaces.DataAccess.I_DataAccess GetDataAccess()
{
	...
	#region Public Parent Tables
		...
		public KinguinProduct_To_Images_CoreClass(string localConnectionString = ""){ LocalConnectionString = localConnectionString; }


		public KinguinProduct_To_Images_CoreClass(int? ID, string localConnectionString = "") 
		{
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		...
		var SQL = "Select * From KinguinProduct_To_Images Where [ID] = @IDParam";
	...
	#region Public Static Search Methods
		...
		public static List<KinguinProduct_To_Images> GetKinguinProduct_To_Images(I_DbWhereStatement Where, string sql = "", string LocalConnectionString = "")
		{
		List<KinguinProduct_To_Images> _TmpReturn = new List<KinguinProduct_To_Images>();
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		if (LocalConnectionString == "") {
		...
		var QR = DataAccess.RunCommand("Select [ID] From KinguinProduct_To_Images Where " + _Where, _Params, true, System.Data.CommandType.Text);
		if (QR.Tables[0].Rows.Count > 0)
		{
		    foreach (System.Data.DataRow r in QR.Tables[0].Rows)
		    {
		        _TmpReturn.Add(new KinguinProduct_To_Images((int?)r["ID"]));
		    }
		}
return _TmpReturn;
		}}

public static List<KinguinProduct_To_Images> Search(string FieldName, string SearchText, bool UseContains = false, string LocalConnectionString = "")
{
List<KinguinProduct_To_Images> _TmpReturn = new List<KinguinProduct_To_Images>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select KinguinProduct_To_Images.ID From KinguinProduct_To_Images Where [" + FieldName + "] like '%' + @SearchParam + '%'";
} 
else { 
SQL = SQL + "Select KinguinProduct_To_Images.ID From KinguinProduct_To_Images Where [" + FieldName + "] = @SearchParam";
}
...
{
_TmpReturn.Add(new KinguinProduct_To_Images((int)Result.Tables[0].Rows[x]["ID"]));
}
}
}}
return _TmpReturn;
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From KinguinProduct_To_Images Where [" + FieldName + "] like '%' + @SearchParam + '%') as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
} 
else { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From KinguinProduct_To_Images Where [" + FieldName + "] = @SearchParam) as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
}
...
public static List<KinguinProduct_To_Images> Search(Dictionary<string,string> FieldValues, string LocalConnectionString = "")
{
List<KinguinProduct_To_Images> _TmpReturn = new List<KinguinProduct_To_Images>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
SQL = SQL + "Select KinguinProduct_To_Images.ID From KinguinProduct_To_Images where ";
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From KinguinProduct_To_Images Where [" + FieldName + "] like '%' + @SearchParam + '%'";} 
else { 
SQL = SQL + "Select * From KinguinProduct_To_Images Where [" + FieldName + "] = @SearchParam";}
...
_Params.Add(new System.Data.SqlClient.SqlParameter("Image_ID_Param", this.Image_ID));
SQLInsertFields += "[Image_ID], ";
SQLValues += "@Image_ID_Param, ";
}
if (this.Type_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Type_ID_Param", this.Type_ID));
SQLInsertFields += "[Type_ID], ";
SQLValues += "@Type_ID_Param, ";
}
...
string _SQL = "Insert Into [KinguinProduct_To_Images] ( " + SQLInsertFields + ") Values (" + SQLValues + ")";
...
if (this.Image_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Image_ID_Param", this.Image_ID));
SQLInsertFields += "[Image_ID] = @Image_ID_Param, ";
}
if (this.Type_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Type_ID_Param", this.Type_ID));
SQLInsertFields += "[Type_ID] = @Type_ID_Param, ";
}
if (this.DateAdded != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("DateAdded_Param", this.DateAdded));
...
string _SQL = "Update [KinguinProduct_To_Images] set " + SQLInsertFields + " Where " + SQLValues;
var _TmpReturn = DataAccess.RunCommand(_SQL, _Params.ToList<System.Data.IDataParameter>(), false, System.Data.CommandType.Text);
...
SQLValues = SQLValues.TrimEnd("AND ".ToCharArray());
string _SQL = "Delete From [KinguinProduct_To_Images] Where " + SQLValues;

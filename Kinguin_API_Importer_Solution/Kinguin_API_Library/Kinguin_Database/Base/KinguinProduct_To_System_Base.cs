...
{
	public class KinguinProduct_To_System_CoreClass : ACT.Plugins.ACT_Core, ACT.Core.Interfaces.DataAccess.I_DataObject 
	{
	...
	private string _LocalConnectionString = "";
		...
		private int? __System_ID;
		private string __System_ID_Description = "";
		private int? __Requirement_ID;
		private string __Requirement_ID_Description = "";
	...
	public virtual string PrimaryKey { get { return "ID"; } }		public virtual int? ID
		...
		public virtual int? System_ID
		{
			get { return __System_ID; }
			set { __System_ID = value; }
		}

		public virtual string System_ID_Description
		{
			get { return __System_ID_Description; }
			set { __System_ID_Description = value; }
		}

		public virtual int? Requirement_ID
		{
			get { return __Requirement_ID; }
			set { __Requirement_ID = value; }
		}

		public virtual string Requirement_ID_Description
		{
			get { return __Requirement_ID_Description; }
			set { __Requirement_ID_Description = value; }
		}
...
public static ACT.Core.Interfaces.DataAccess.I_DataAccess GetDataAccess()
{
	...
	#region Public Parent Tables
		...
		public KinguinProduct_To_System_CoreClass(string localConnectionString = ""){ LocalConnectionString = localConnectionString; }


		public KinguinProduct_To_System_CoreClass(int? ID, string localConnectionString = "") 
		{
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		...
		var SQL = "Select * From KinguinProduct_To_System Where [ID] = @IDParam";
	...
	#region Public Static Search Methods
		...
		public static List<KinguinProduct_To_System> GetKinguinProduct_To_System(I_DbWhereStatement Where, string sql = "", string LocalConnectionString = "")
		{
		List<KinguinProduct_To_System> _TmpReturn = new List<KinguinProduct_To_System>();
		using(var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
		if (LocalConnectionString == "") {
		...
		var QR = DataAccess.RunCommand("Select [ID] From KinguinProduct_To_System Where " + _Where, _Params, true, System.Data.CommandType.Text);
		if (QR.Tables[0].Rows.Count > 0)
		{
		    foreach (System.Data.DataRow r in QR.Tables[0].Rows)
		    {
		        _TmpReturn.Add(new KinguinProduct_To_System((int?)r["ID"]));
		    }
		}
return _TmpReturn;
		}}

public static List<KinguinProduct_To_System> Search(string FieldName, string SearchText, bool UseContains = false, string LocalConnectionString = "")
{
List<KinguinProduct_To_System> _TmpReturn = new List<KinguinProduct_To_System>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select KinguinProduct_To_System.ID From KinguinProduct_To_System Where [" + FieldName + "] like '%' + @SearchParam + '%'";
} 
else { 
SQL = SQL + "Select KinguinProduct_To_System.ID From KinguinProduct_To_System Where [" + FieldName + "] = @SearchParam";
}
...
{
_TmpReturn.Add(new KinguinProduct_To_System((int)Result.Tables[0].Rows[x]["ID"]));
}
}
}}
return _TmpReturn;
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From KinguinProduct_To_System Where [" + FieldName + "] like '%' + @SearchParam + '%') as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
} 
else { 
SQL = SQL + "Select * From ( Select *, ROW_NUMBER() Over(order by " + OrderByStatement + ") as RowNum From KinguinProduct_To_System Where [" + FieldName + "] = @SearchParam) as T Where T.RowNum > " + (Start-1).ToString() + " AND T.RowNum < " + (Start + Increment).ToString();
}
...
public static List<KinguinProduct_To_System> Search(Dictionary<string,string> FieldValues, string LocalConnectionString = "")
{
List<KinguinProduct_To_System> _TmpReturn = new List<KinguinProduct_To_System>();
using (var DataAccess = ACT.Core.CurrentCore<ACT.Core.Interfaces.DataAccess.I_DataAccess>.GetCurrent()){
...
var SQL = "";
SQL = SQL + "Select KinguinProduct_To_System.ID From KinguinProduct_To_System where ";
...
var SQL = "";
if (UseContains == true) { 
SQL = SQL + "Select * From KinguinProduct_To_System Where [" + FieldName + "] like '%' + @SearchParam + '%'";} 
else { 
SQL = SQL + "Select * From KinguinProduct_To_System Where [" + FieldName + "] = @SearchParam";}
...
_Params.Add(new System.Data.SqlClient.SqlParameter("System_ID_Param", this.System_ID));
SQLInsertFields += "[System_ID], ";
SQLValues += "@System_ID_Param, ";
}
if (this.Requirement_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Requirement_ID_Param", this.Requirement_ID));
SQLInsertFields += "[Requirement_ID], ";
SQLValues += "@Requirement_ID_Param, ";
}
...
string _SQL = "Insert Into [KinguinProduct_To_System] ( " + SQLInsertFields + ") Values (" + SQLValues + ")";
...
if (this.System_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("System_ID_Param", this.System_ID));
SQLInsertFields += "[System_ID] = @System_ID_Param, ";
}
if (this.Requirement_ID != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("Requirement_ID_Param", this.Requirement_ID));
SQLInsertFields += "[Requirement_ID] = @Requirement_ID_Param, ";
}
if (this.DateAdded != null){ 
_Params.Add(new System.Data.SqlClient.SqlParameter("DateAdded_Param", this.DateAdded));
...
string _SQL = "Update [KinguinProduct_To_System] set " + SQLInsertFields + " Where " + SQLValues;
var _TmpReturn = DataAccess.RunCommand(_SQL, _Params.ToList<System.Data.IDataParameter>(), false, System.Data.CommandType.Text);
...
SQLValues = SQLValues.TrimEnd("AND ".ToCharArray());
string _SQL = "Delete From [KinguinProduct_To_System] Where " + SQLValues;

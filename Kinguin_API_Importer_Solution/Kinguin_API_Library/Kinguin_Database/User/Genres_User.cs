...
namespace IVolt.Kinguin.API.LocalDB
{
    ...
    public class Genres : Genres_CoreClass
    {
        ...
        /// <param name="Conn">The Conn<see cref="string"/>.</param>
        public Genres(int? ID, string Conn = "") : base(ID, Conn)
        {
        }
        ...
        {
            var _SearchResults = Genres.Search("Name", GenName, false);
